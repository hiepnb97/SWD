 ...
 * @author Hoang Hiep
 */
public class DontAcceptRequestFriend extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        requestFriendDAO.cancelRequestFriend(toUserID, fromUserID);
        response.sendRedirect("listrequestfriend.jsp");
    }
